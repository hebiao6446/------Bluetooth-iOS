...
-(void)peripheral:(CBPeripheral *)p didReadRSSI:(NSNumber *)RSSI error:(NSError *)error{
    
    NSLog(@"++++++++++++++++++%@",RSSI);
    [_mydelegate connetedPeripheral:p withRSSI:RSSI];
}
...
-(void)disconnect:(CBPeripheral *)_peripheral
{
...
-(void)centralManager:(CBCentralManager *)central didDisconnectPeripheral:(CBPeripheral *)_peripheral error:(NSError *)error{
//     [self.centralManager connectPeripheral:_peripheral options:nil];
}
